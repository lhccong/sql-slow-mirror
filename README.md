...
##      exceptSqlIds: com.cong.example.mapper.TaskMapper.selectList,com.cong.example.mapper.TaskMapper.xxx
      sqlType: SELECT,UPDATE
      outModel: LOG
      outputClass: com.cong.example.out.MySqlScoreResultOutService
```
